...
\documentclass[
    ...
    TitleEng        = {{Research on Smart Contract Vulnerability Detection Method Based on Feature Fusion}}
]{zjuthesis}
\setcounter{tocdepth}{2}
%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于特征融合的智能合约漏洞检测}{与运行崩溃预测研究}
\titleengtwolines{Research on Smart Contract Vulnerability}{Detection Method Based on Feature Fusion}
