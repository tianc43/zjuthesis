...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        分类号：           & \underline{\hfill TP311.5 \hfill}  &
        单位代码：         & \uline{\hfill 10335 \hfill} \\
        密{\quad}级：      & \underline{\quad 无 \quad} &
        学{\quad\quad}号： & \underline{22121233}
    \end{tabularx}
\end{center}


\begin{center}
    \includegraphics[width=0.5\paperwidth]{pictures/zjuchar.pdf}
\end{center}
...
\begin{center}
    \bfseries \zihao{-2}
    \begin{tabularx}{.98\textwidth}{>{\fangsong}l X<{\centering}}
